...
circle.setAttribute('transform', `rotate(-90,${circleCenter[0]},${circleCenter[1]})`);

function calcCircleOffset(){
    console.log((timer.duration/timer.initialDuration * circlePerimeter) - circlePerimeter);
    return   (timer.duration/timer.initialDuration * circlePerimeter) - circlePerimeter;
}